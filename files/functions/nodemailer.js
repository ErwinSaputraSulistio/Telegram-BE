...
exports.sendEmail = (token, email, name) => {
   const sendThisMail = {
      ...
      to: email,
      subject: 'Telegram: Account Verification',
      html:
         `<!DOCTYPE html>
         <html lang="en">
            <head>
            ...
            <body>
               <div class="container">
                  ...
                  <p style="font-size: 15px;">Halo ${name}, selamat bergabung di grup besar Telegram! Agar kamu bisa login dan mengakses akun kamu lebih lanjut, harap verifikasi akun kamu terlebih dahulu yah dengan cara menekan tombol verifikasi di bawah ini :</p>
                  <div style="margin: auto; margin-top: 40px; width: 100%;">
                     <a class="verifyLink" href="https://telegram-erwinsaputrasulistio.vercel.app/verify/${token}"><div class="verifyBtn">Verifikasi Akun</div></a>
                  </div>
               </div>
            </body>
         </html>`
...
exports.resetPassword = (jwtToken, userEmail) => {
   const sendThisMail = {
     from: 'ciwin.tickitz@gmail.com',
     to: userEmail,
     ...
     html:
       ...
       <html lang="en">
          ...
          <body>
             <div class="container">
                <img style="width: 240px; height: 80px;" src="https://image.myanimelist.net/ui/uf6p6rEk2dlZoh8DIyYQTScPXcYWVkorZzR5QFff8Dz3qY2oXvvW5x3Hrb-W5JxGHRwmguU8B08LZEEOtbv2G3WKIJ9sNYmr_hbsa72u_rSA04XHa2uGxv_npt3alTiqCO1wZi7NrJbnS1vOPJyjoZkSTvU9Syn4esm53zmf6UE"/>
                <p style="font-size: 15px;">Halo ${userEmail}, Untuk melanjutkan proses reset password akun kamu, silahkan menekan tombol di bawah ini :</p>
                <div style="margin: auto; margin-top: 40px; width: 100%;">
                   <a class="verifyLink" href="https://telegram-erwinsaputrasulistio.vercel.app/forgot-password/${jwtToken}"><div class="verifyBtn">Reset Password</div></a>
                </div>
             </div>
          </body>
       </html>`
